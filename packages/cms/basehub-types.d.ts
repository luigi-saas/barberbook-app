...
declare module "basehub" {
  export interface QueryGenqlSelection {
    // Loose index signature for tokenless builds; real types come from the
    // BaseHub token build. Allows hand-written blog/legalPages queries.
    [key: string]: any;
  }
  ...
  export interface FragmentsMap extends _FragmentsMap {
    // Content types referenced by @repo/cms fragments. Full, precise types are
    // regenerated by the BaseHub plugin at build time when BASEHUB_TOKEN is
    // set; these loose entries keep tokenless builds (local dev/CI) compiling.
    BlockImage: { selection: any; type: any };
    PostsItem: { selection: any; type: any };
    LegalPagesItem: { selection: any; type: any };
    blog: { selection: any; type: any; __args?: any };
    legalPages: { selection: any; type: any; __args?: any };
  }
