...
export function BBShopCard({
  ...
  return (
    <div
      className={cn(
        'overflow-hidden rounded-bb-card bg-white shadow-[var(--bb-shadow-card)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_4px_8px_rgba(28,27,27,0.05),0_20px_44px_-20px_rgba(28,27,27,0.18)]',
        className,
      )}
    >
      {/* Image */}
